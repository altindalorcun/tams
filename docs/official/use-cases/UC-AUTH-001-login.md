...
| ---                      | ---                                                                                                                                            |
| Containing Use-Case(s)   | Extends UC-AUTH-003 when `mustChangePassword` is true on first login. |
| ---                      | ---                                                                                                                                            |
